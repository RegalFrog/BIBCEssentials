---
title: "Notebook for Brahma Scoring"
output: 
  github_document:
    toc: true
    toc_depth: 3
...
We have different colors, of which the light version have been scored in this dataset. 
...
All animals were weight at each scoring, the weight is expressed in grams.

A link to the weight distribution can be found here in [R](R/MyFirstVisual.md), [python](Python/MyFirstVisual.ipynb) and [tableau](https://public.tableau.com/profile/bovianalytics#!/vizhome/BrahmaScorings/Scatterplot)
...
The animals need to have a typical brahma type as shown in the pictures above.

# Clustering methods

A link to the k-means clustering can be found here in R [for 2 variables](R/KMeans2Variables.md) and [for k variables](R/KMeansKVariables.md),